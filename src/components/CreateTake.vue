...
<template>
    ...
    <div class=" w-full px-[3%] md:px-[14%] flex flex-col gap-7 text-[--text2-color] text-sm placeholder-[rgba(255,255,255,0.7)]">
        ...
        <div class="flex flex-col gap-2">
            ...
            <input type="text" v-model = 'newTake' name="Name" placeholder="Your best take is..." class=" px-3 py-2 rounded-lg bg-[#5349492d] border border-[#53494954] placeholder-[rgba(255,255,255,0.7)] outline ring-1 outline-0 outline-gray-100">
        </div>
        
        <div class="flex flex-col gap-2">
            <span class="text-base font-medium">Description</span>
            <input v-model = 'Description' name="note" id="note" cols="30" rows="2" class="rounded-lg p-3 bg-[#5349492d] border border-[#53494954] placeholder-[rgba(255,255,255,0.7)] py-3 outline ring-1 outline-0 outline-gray-100" placeholder="(optional) Take description..."></input>
        </div>
        <div class="flex flex-col gap-2">
            ...
            <input @keyup.enter="addChoice" v-model = 'choices' name="note" id="note" cols="30" rows="2" class="rounded-lg p-3 bg-[#5349492d] border border-[#53494954] placeholder-[rgba(255,255,255,0.7)] outline ring-1 outline-0 outline-gray-100" placeholder="Press enter to add more options" required></input>
        </div>
